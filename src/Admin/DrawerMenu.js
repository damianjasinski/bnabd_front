...
export default function PersistentDrawerLeft() {
  ...
  return (
    ...
    <Box sx={{ display: "flex" }}>
      <CssBaseline />
      <AppBar position="fixed" open={open} sx = {{backgroundColor :"#303131"}}>
        <Toolbar >
          <IconButton
            color="inherit"
            ...
            edge="start"
            sx={{ mr: 2, ...(open && { display: "none" }), color : '#e87800' }}
          >
            <MenuIcon />
          </IconButton>
          <Typography variant="h4" noWrap component="div" sx = {{color:'#e87800'}}>
            Panel Admina
          </Typography>
        </Toolbar>
      </AppBar>
